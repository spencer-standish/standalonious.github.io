...
const Questions = [{
    ...
    a: [{ text: "fruits and vegetables", isCorrect: false, isSelected: false },
        { text: "leftovers from polar bear kills", isCorrect: false },
        { text: "lemmings", isCorrect: true },
        { text: "whatever washes up on the seashore", isCorrect: false }
    ]
...
},
{
    ...
    a: [{ text: "a cub", isCorrect: false, isSelected: false },
        { text: "a kitten", isCorrect: false },
        { text: "a baby", isCorrect: false },
        { text: "a leveret", isCorrect: true }
    ]
...
},
{
    ...
    a: [{ text: "Flipper", isCorrect: false, isSelected: false },
        { text: "Dorsal fin", isCorrect: true },
        { text: "Red spot", isCorrect: false },
...
},
{
    ...
    a: [{ text: "Flocks", isCorrect: false, isSelected: false },
        { text: "Packs", isCorrect: false },
        { text: "Litters", isCorrect: false },
        { text: "Pods", isCorrect: true }
    ]
...
},
{
    ...
    a: [{ text: "Their claws aren't long enough.", isCorrect: false, isSelected: false },
        { text: "They weigh too much.", isCorrect: true },
        { text: "They are afraid of heights.", isCorrect: false },
        { text: "They dont know how to climb", isCorrect: false }
    ]
...
},
{
    ...
    a: [{ text: "Up to 35 miles an hour", isCorrect: true, isSelected: false },
        { text: "Up to 50 miles an hour", isCorrect: false },
        { text: "Up to 5 miles an hour", isCorrect: false },
        { text: "A moose can't run", isCorrect: false }
    ]
...
},
{
    ...
    a: [{ text: "Bull", isCorrect: false, isSelected: false },
        { text: "Doe", isCorrect: false },
        { text: "Cow", isCorrect: false },
        { text: "Calf", isCorrect: true }
    ]
...
},
{
    ...
    a: [{ text: "They starved.", isCorrect: false, isSelected: false },
        { text: "People hunted them.", isCorrect: true },
        { text: "They didn't have enough baby calves.", isCorrect: false },
        { text: "The temperature got to hot for them to survive.", isCorrect: false }
    ]
...
},
{
    ...
    a: [{ text: "Brackish", isCorrect: false, isSelected: false },
        { text: "Fresh", isCorrect: false },
        { text: "Salt", isCorrect: false },
        { text: "Estuarine", isCorrect: true }
    ]
...
},
{
    ...
    a: [{ text: "the Arctic", isCorrect: true, isSelected: false },
        { text: "the Antarctic", isCorrect: false },
